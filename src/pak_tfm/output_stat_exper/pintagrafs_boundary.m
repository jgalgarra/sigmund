...
mediax = round(1/10*((Mb1(:,1)+Mb2(:,1)+Mb3(:,1)+Mb4(:,1)+Mb5(:,1)+Mb6(:,1)+Mb7(:,1)+Mb8(:,1)+Mb9(:,1)+Mb10(:,1))) );
mediay = round(1/10*((Mb1(:,2)+Mb2(:,2)+Mb3(:,2)+Mb4(:,2)+Mb5(:,2)+Mb6(:,2)+Mb7(:,2)+Mb8(:,2)+Mb9(:,2)+Mb10(:,2))) );
